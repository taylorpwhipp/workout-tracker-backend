"""
URL configuration for daily_workout_backend project.
...
from workouts.views import create_workout, get_workouts
from exercises.views import get_muscle_groups
